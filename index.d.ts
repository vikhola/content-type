declare module "@vikhola/content-type" {
    ...
    export class ContentType {
        /**
         * ContentType accepts optional type and params which will be assigned to its instance.
         * 
        ...
        /**
         * The `contentType.type` is current type.
         */
        type: string
        /**
         ...
         * parses it, and returns a new ContentType instance with the type and params.
         * 
